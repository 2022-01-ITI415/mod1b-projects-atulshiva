...
public class CloudCrafter : MonoBehaviour
{
    ...
    public int numClouds = 40; // The # of clouds
   
public GameObject CloudPrefab; // The prefab for
    
public Vector3 cloudPosMin = new Vector3(-50, -5, 10);
    public Vector3 cloudPosMax = new Vector3(150, 100, 10);
    public float cloudScaleMin = 1; // Min scale of
    
public float cloudScaleMax = 3; // Max scale of
    
public float cloudSpeedMult = 0.5f; // Adjusts speed
    
private GameObject[] cloudInstances;
    void Awake()
    {
        // Make an array large enough to hold all the Cloud_
        ...
        for (int i = 0; i < numClouds; i++)
        {
            ...
            // Smaller clouds (with smaller scaleU) should be
